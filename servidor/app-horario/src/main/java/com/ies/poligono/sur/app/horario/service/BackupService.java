...
public class BackupService {
	...
	public String generarTxtHorario() {
		...
		for (Horario h : horarios) {
			...
			String aula = h.getAula() != null ? h.getAula().getCodigo() : "";
			...
			sb.append(asig).append("\t").append(curso).append("\t").append(aula).append("\t").append(profe).append("\t")
					.append(dia).append("\t").append(hora).append("\n");
		}
		return sb.toString();
	}
	...
	public void importarDatos(BackupDataDTO datos) {
		...
		if (datos.getCursos() != null)
			cursoRepository.saveAll(datos.getCursos());
		if (datos.getAsignaturas() != null)
			asignaturaRepository.saveAll(datos.getAsignaturas());
		if (datos.getAulas() != null)
			aulaRepository.saveAll(datos.getAulas());
		if (datos.getProfesores() != null)
			profesorRepository.saveAll(datos.getProfesores());
		if (datos.getHorarios() != null)
			horarioRepository.saveAll(datos.getHorarios());
	}
	...
	private String convertirDiaLetra(String dia) {
		...
		if (dia.contains("MIERCOLES") || dia.contains("MIÉRCOLES"))
			return "X";

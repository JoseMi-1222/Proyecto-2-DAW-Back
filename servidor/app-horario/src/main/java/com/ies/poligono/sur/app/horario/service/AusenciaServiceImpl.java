...
public class AusenciaServiceImpl implements AusenciaService {
	...
	@Override
	public void justificarAusenciasDia(LocalDate fecha, Long idProfesor, String nombreJustificante) {
		List<Ausencia> ausencias = ausenciaRepository.findByFechaAndHorario_Profesor_IdProfesor(fecha, idProfesor);
		for (Ausencia ausencia : ausencias) {
			ausencia.setJustificante(nombreJustificante);
	...
	@Override
	public void aprobarJustificante(LocalDate fecha, Long idProfesor) {
		List<Ausencia> ausencias = ausenciaRepository.findByFechaAndHorario_Profesor_IdProfesor(fecha, idProfesor);
		for (Ausencia ausencia : ausencias) {
